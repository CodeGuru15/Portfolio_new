const Portfolio = () => {
  ...
  return (
    <div className=" h-screen  text-white bg-[url('../../public/project.webp')] bg-cover bg-no-repeat">
        ...
        <ul className=" flex flex-wrap gap-2 justify-center">
          {projects.map((item, index) => {
            return (
              <li
                key={index}
                className="w-52 sm:w-72 border text-center sm:text-xl px-3 py-1 h-32 flex flex-col place-content-center rounded-md"
              >
